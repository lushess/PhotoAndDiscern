...
////对于EN25Q64
////前6M字节给fatfs用,6M字节后,用于存放字库,字库占用1.5M. 剩余部分给自己用	 			    
//u16	    FLASH_SECTOR_COUNT=1536;	//EN25Q64,前6M字节给FATFS占用
//#define FLASH_BLOCK_SIZE   	1     	//每个BLOCK有8个扇区，擦除时按BLOCK擦除，因此为4096个字节即一个扇区
...
)
{
	...
	case EX_FLASH :
	  ...
	  //FLASH_SECTOR_COUNT=1536;//EN25Q64,前6M字节分配给FATFS
